...
public class Patient {
    ...
    public Patient(String id, String first_name, String last_name, String district, int location_x, int location_y, String severity_level, String gender, String contact, String email, int age, java.util.Date admit_date, String admitted_by, java.util.Date discharge_date, String discharged_by) {
    }
